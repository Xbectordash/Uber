// SignUp captain request

class CaptainRegisterRequest {
  Fullname? _fullname;
  String? _email;
  String? _password;
  Vehicle? _vehicle;
  ...
  CaptainRegisterRequest.fromJson(Map<String, dynamic> json) {
...
// captain response
class CaptainRegisterResponse {
  String? _message;
  Captain? _captain;
  String? _token;

  CaptainRegisterResponse({String? message, Captain? captain, String? token}) {
    if (message != null) {
  ...
  CaptainRegisterResponse.fromJson(Map<String, dynamic> json) {
